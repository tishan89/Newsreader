 ...
 * 
 */
public interface INNTPServerStoreFacade extends IInputOutputSystem,
		IBasicNNTPInterface, IAdministration, IServerStoreFacade {
	 ...
	 */
	public INewsgroup getSubscribedNewsgroup(INNTPServer server,
			String newsgroup);
	...
	/**
	 * Moves the updated attributes from the newsgroup into the store.
	 * 
	 * @throws NNTPIOException
	 * @throws UnexpectedResponseException
	 * @throws StoreException
	 */
	public void updateAttributesInStore(INewsgroup newsgroup)
	 ...
	 * @param newsgroup
	 *            Newsgroup
	 * @param isNewArticlePosted
	 *            whether a new article is posted just before sync.
	 */
	public void syncStoreWithServer(INewsgroup newsgroup,
			boolean isNewArticlePosted) throws NNTPIOException,
